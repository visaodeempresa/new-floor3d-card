...
[![Version](https://img.shields.io/badge/version-v4.1.2--r133-blue.svg?style=for-the-badge)](https://github.com/visaodeempresa/new-floor3d-card/releases/tag/v4.1.2-r133)
...
## Community Contribution — Three.js r133 Compatibility Update
...
- **Three.js upgraded from r132 → r133** — the 3D engine that powers the entire card was bumped to the latest stable revision, ensuring compatibility with modern browsers and future HA updates.
- **Zero breaking changes** — a thorough analysis of the r133 release notes confirmed that none of the breaking changes affected this project. Not a single line of source code needed to change.
...
*v4.1.2-r133 — Three.js r133 compatibility · Community contribution by [@visaodeempresa](https://github.com/visaodeempresa)*
